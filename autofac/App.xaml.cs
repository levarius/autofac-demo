...
namespace autofac
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            builder.RegisterType<MyHandler>().As<HttpMessageHandler>();

            builder.Register(x => ResourceLoader.GetForViewIndependentUse());
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                var vm = m_container.Resolve<MyViewModel>();
